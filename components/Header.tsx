        ...
        <div className="flex items-center gap-2">
          ...
          >
            <input
              ...
              placeholder="Search..."
              aria-label="Search articles"
              className="w-40 rounded-none border-2 border-ink bg-white px-3 py-1.5 text-sm text-ink placeholder:text-moss focus:border-marker focus:outline-none lg:w-48"
            />
